...
export default function MainHeader() {
  ...
  return (
    ...
    "
                  ...
                  <div className="flex justify-center">
                    <h6 className="text-sm font-medium">
                      New User? <span className="text-orange-600 cursor-pointer " onClick={sigupToggle}>Sign Up</span>
                    </h6>
                  </div>
    ...
    "
                    ...
                    <div class="px-6 pt-4 pb-2 flex justify-center">
                      <span class="inline-block bg-orange-600 _savespso cursor-pointer rounded text-sm font-semibold text-white mr-2 mb-2 pl-16 p-3 pr-16">
                        SIGNUP
                      </span>
                    </div>
                  </form>
                  <div className="flex justify-center">
                    <h6 className="text-sm font-medium">
                      Already a User?{" "}
                      <span className="text-orange-600 cursor-pointer" onClick={toggle}>Login</span>
                    </h6>
                  </div>
                  <div className="flex justify-center mt-3 items-center">
                    <h6 className="text-sm font-medium text-gray-500">
