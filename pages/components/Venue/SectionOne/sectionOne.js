  ...
  return (
    <div>
      <section className="p-10">
          {/* Find New Vuene */}
      <div className="show_venue_filter" style={{display: chipsShow ? "block" : "none"}}>
        <ShowVenue />
      </div>
    ...
    bg-clip-padding bg-no-repeat
      ...
      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
          ...
          <div>
            <button onClick={showHideChip} class="text-white _savespso font-bold py-2 px-4 border text-sm rounded">
              Fine Venue
            </button>
          </div>
        </div>
