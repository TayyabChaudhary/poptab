    ...
    <>
              ...
              <div>
                <div className="bb relative">
                  <div className="w-48 absolute bottom-3 right-3 bg-white rounded-md p-2 cursor-pointer">
                    ...
                    <svg class="gb_Te" width="20px" height="20px" focusable="false" viewBox="0 0 24 24"><path d="M6,8c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2zM12,20c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2zM6,20c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2zM6,14c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2zM12,14c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2zM16,6c0,1.1 0.9,2 2,2s2,-0.9 2,-2 -0.9,-2 -2,-2 -2,0.9 -2,2zM12,8c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2zM18,14c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2zM18,20c1.1,0 2,-0.9 2,-2s-0.9,-2 -2,-2 -2,0.9 -2,2 0.9,2 2,2z"></path></svg>
                        <h5 className="text-md text-blue-900 font-medium pl-2">Show all photos</h5>
                    </div>
                  </div>
                </div>
      ...
      <div className="p-10">
        <div className="flex flex-row justify-between">
          <div>
            <h1 className="text-4xl pl-6 _opaoao text-orange-600">
              Bliss on the Ocean
            </h1>
            <ul>
      ...
      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                ...
                <div>
                  ...
                  <div className="flex justify-between pb-3 mt-3">
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 1</span>
                    </div>
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 2</span>
                    </div>
                  </div>
                  <div className="flex justify-between pb-3">
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 3</span>
                    </div>
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 4</span>
                    </div>
                  </div>
                  <div className="flex justify-between pb-3">
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 5</span>
                    </div>
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 6</span>
                    </div>
                  </div>
                  <div className="flex justify-between pb-3">
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 7</span>
                    </div>
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Services 8</span>
                    </div>
                  </div>
                  <div className="flex justify-between pb-3">
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Service 9</span>
                    </div>
                    <div>
                      <input type="checkbox" />
                      <span className="text-sm ml-2 text-blue-900 font-medium">Service 10</span>
                    </div>
                  </div>
                  <div>
