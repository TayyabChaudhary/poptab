...
import PackageVenueDetailsSection from "../VenueDetailsSecond/PackagesSection/packagesection";
        ...
        <div className="relative -top-16">
          <div className="pt-4">
            <div className="grid grid-cols-4 gap-4">
              <div>
                  <div className="one bg-no-repeat rounded-0 flex justify-center items-center">
                    
                  </div>
              </div>
              <div>
                  <div className="two bg-no-repeat rounded-0 flex justify-center items-center"> </div>
              </div>
              <div>
          ...
          <div className="_p_12_s_s shadow-sm rounded-md p-4 mt-5 ml-6">
            ...
            >
              ...
              <div className="flex pt-3">
                  <div className="pr-3">
                  <V src="/bb.png" width="80px" className="mr-3" height="60px" />
                  </div>
                  <div className="pr-3">
                  <V src="/image 46.png" width="80px" className="mr-3" height="60px" />
                  </div>
                  <div className="pr-3">
                  <V src="/image 112.png" width="80px" className="mr-3" height="60px" />
                  </div>
                  <div className="pr-3">
                  <V src="/image 113.png" width="80px" className="mr-3" height="60px" />
                  </div>
              </div>
            </div>
          </div>
